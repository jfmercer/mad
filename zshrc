...
plugins=(git git-flow laravel5 node python osx brew brew-cask composer sublime ruby rvm gem ssh-agent sudo vundle zsh-syntax-highlighting zsh-history-substring-search composer vagrant)
