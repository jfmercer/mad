...
# Install all PHPs
brew install php53 php53-mcrypt php53-oauth php53-xdebug php54 --with-phpdebug php55 --with-phpdebug php56 --with-phpdebug && brew unlink php53 && brew link php54 && brew install php54-mcrypt php54-oauth php54-xdebug && brew unlink php54 && brew link php55 && brew install php55-mcrypt php55-oauth php55-xdebug && brew unlink php55 && brew link php56 && brew install php56-mcrypt php56-oauth php56-xdebug

# Install composer independently of Homebrew
